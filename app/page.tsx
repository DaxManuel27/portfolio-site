        ...
        <div className={styles.container}>
          <div className={styles.heroLayout}>
            <div className={styles.heroLeft}>
              ...
              <a href="/NikolasDaxManuel-ResumeFeb10" download className={styles.resumeButton} aria-label="Resume">
            ...
            <div className={styles.heroRight}>
              ...
              <div className={styles.aboutSection}>
                ...
                <p className={styles.aboutText}>
                  My interests span across software engineering, machine learning, and computer vision. Specifically in EVs, AVs and robotics.
                </p>
              </div>
            </div>
          </div>
